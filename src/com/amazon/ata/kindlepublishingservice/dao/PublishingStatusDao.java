...
public class PublishingStatusDao {
    ...
    public List<PublishingStatusItem> getPublishingStatuses(String publishingStatusId) {
        ...
        DynamoDBQueryExpression<PublishingStatusItem> queryExpression = new DynamoDBQueryExpression<PublishingStatusItem>().withHashKeyValues(publishingStatusItem);
        PaginatedQueryList<PublishingStatusItem> publishingStatusItems = dynamoDbMapper.query(PublishingStatusItem.class, queryExpression);
        if (publishingStatusItems.isEmpty()) {
            throw new PublishingStatusNotFoundException("No publishing status found for id: " + publishingStatusId);
        }
